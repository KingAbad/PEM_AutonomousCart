...
//Page 1:Command     
#define     Reserved10            0x10  // 0x10
#define     ModeReg               0x11  // 0x3Fh
#define     TxModeReg             0x12  // 0x00
#define     RxModeReg             0x13  // 0x00
#define     TxControlReg          0x14  // 0x80
#define     TxASKReg              0x15  // 0x00
#define     TxSelReg              0x16  // 0x10
#define     RxSelReg              0x17  // 0x84
#define     RxThresholdReg        0x18  // 0x84
#define     DemodReg              0x19  // 0x4D
#define     Reserved11            0x1A  // 0x00
#define     Reserved12            0x1B  // 0x00
#define     MifareReg             0x1C  // 0x62
#define     Reserved13            0x1D  // 0x00
#define     Reserved14            0x1E  // 0x00
#define     SerialSpeedReg        0x1F  // 0xeb
//Page 2:CFG    
