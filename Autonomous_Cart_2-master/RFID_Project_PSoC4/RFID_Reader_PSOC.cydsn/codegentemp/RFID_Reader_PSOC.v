// ======================================================================
// RFID_Reader_PSOC.v generated from TopDesign.cysch
// 03/30/2020 at 15:23
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6e587b50-3805-4f63-b315-aacb9046cd15"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__BUZZERGROUND_net;
	wire [0:0] tmpFB_0__BUZZERGROUND_net;
	wire [0:0] tmpIO_0__BUZZERGROUND_net;
	wire [0:0] tmpINTERRUPT_0__BUZZERGROUND_net;
	electrical [0:0] tmpSIOVREF__BUZZERGROUND_net;

	cy_psoc3_pins_v1_10
		#(.id("432f6fbc-9ab3-491d-9ae7-71e408718272"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUZZERGROUND
		 (.oe(tmpOE__BUZZERGROUND_net),
		  .y({Net_133}),
		  .fb({tmpFB_0__BUZZERGROUND_net[0:0]}),
		  .io({tmpIO_0__BUZZERGROUND_net[0:0]}),
		  .siovref(tmpSIOVREF__BUZZERGROUND_net),
		  .interrupt({tmpINTERRUPT_0__BUZZERGROUND_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUZZERGROUND_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("40ca2565-1c3e-4425-a930-6ca59f98999e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("90bf461c-b751-44d1-8833-ede41b78bbfa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
